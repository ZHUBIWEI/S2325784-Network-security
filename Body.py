...
class Body:
    ...
    @staticmethod
    def compute_all_metrics(recon_errors, labels, threshold):
        recon_errors = recon_errors.cpu().numpy()
        labels = labels.cpu().numpy()
    ...
    def visualize_losses(self):
        ...
        plt.tight_layout()
        plt.savefig(self.plot_dir + f"{self.model_name}_loss.pdf")
    ...
    def start_experiment(self):
        ...
        for epoch in range(1, self.epoch_num + 1):
            ...
            epoch_f1, threshold = self.compute_best_f1(self,epoch,recon_errors, labels, return_threshold=True)
