...
###############################################################################################
    # If you do not want to test K-fold, you can just comment out belwo code
    ...
    for train_indices, val_indices in kfold.split(exp.train_loader.dataset):
        ...
        for epoch in range(1, exp.epoch_num + 1):
            ...
            epoch_f1, threshold = exp.compute_best_f1(epoch,recon_errors, labels, return_threshold=True)
